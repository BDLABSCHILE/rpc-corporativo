        ...
        <div className="mx-auto max-w-5xl px-6 py-16 lg:px-10 lg:py-24">
          ...
          <div className="mt-10 flex flex-col gap-3 sm:flex-row sm:items-center">
            <a
              ...
              className="inline-flex items-center justify-center gap-3 rounded-rpc-button bg-rpc-button px-7 py-4 text-xs uppercase tracking-[0.2em] text-rpc-button-text transition hover:opacity-90"
            >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-3 rounded-rpc-button border border-rpc-text px-7 py-4 text-xs uppercase tracking-[0.2em] text-rpc-text transition hover:bg-rpc-text hover:text-rpc-button-text"
            >
              {CONTACT.email}
            </a>
          </div>
        ...
        <div className="mx-auto max-w-5xl px-6 py-16 lg:px-10 lg:py-20">
          <div className="grid gap-12 lg:grid-cols-[280px_1fr] lg:gap-20">
            <div>
              ...
              <h2 className="mt-4 font-rpc-heading text-2xl font-light leading-[1.1] text-rpc-text sm:text-3xl">
      ...
      <section className="bg-rpc-bg">
        <div className="mx-auto max-w-5xl px-6 py-16 lg:px-10 lg:py-20">
          ...
          <div className="mt-8 grid gap-x-10 gap-y-8 sm:grid-cols-2">
            ...
            <SocialItem
              label="Facebook"
              value="Ropa Publicitaria Chile"
              href={rpcTokens.social.facebook}
            />
          </div>
        </div>
      </section>
  ...
  return (
    <div className="border-t border-rpc-border pt-4">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer noopener"
        className="mt-2 inline-block font-rpc-body text-lg normal-case tracking-normal text-rpc-text underline-offset-4 hover:underline"
      >
        {value}
      </a>
    </div>
