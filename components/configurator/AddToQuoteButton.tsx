  ...
  if (state === "added") {
    return (
      <div className="space-y-2">
        <div className="flex w-full items-center justify-between gap-3 rounded-rpc-button border border-rpc-text bg-rpc-text px-6 py-4 text-rpc-button-text">
          <span className="text-xs uppercase tracking-[0.2em]">
            ✓ Agregado a tu cotización
          </span>
          {pricing && (
            <span className="font-rpc-body text-xs tracking-normal opacity-80">
