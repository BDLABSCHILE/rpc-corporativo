        ...
        {options.map((opt) =>
          opt.isCurrent ? (
            <span
              ...
              aria-current="true"
              title={opt.color}
              className="relative h-12 w-12 overflow-hidden rounded-full bg-rpc-image-bg-light ring-2 ring-rpc-text ring-offset-2 ring-offset-rpc-bg"
            >
              <Image
                src={opt.imageUrl}
                alt={opt.color}
            ...
            <Link
              ...
              className="relative h-12 w-12 overflow-hidden rounded-full bg-rpc-image-bg-light ring-1 ring-rpc-border transition hover:ring-2 hover:ring-rpc-text"
            >
              <Image
                src={opt.imageUrl}
                alt={opt.color}
