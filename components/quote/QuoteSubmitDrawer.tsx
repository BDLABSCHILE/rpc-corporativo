      ...
      >
        <header className="flex items-center justify-between border-b border-rpc-border px-6 py-5">
          ...
          <button
            ...
            disabled={pending}
            aria-label="Cerrar"
            className="flex h-10 w-10 items-center justify-center rounded-rpc-button text-rpc-text hover:bg-rpc-image-bg-light disabled:cursor-not-allowed disabled:opacity-40"
          >
          ...
          >
            ...
            <div className="flex-1 space-y-5 overflow-y-auto px-6 py-6">
              ...
              {formError && (
                <p
                  role="alert"
                  className="rounded border border-rpc-error/30 bg-rpc-error/5 px-4 py-3 text-sm text-rpc-error"
                >
                  {formError}
                </p>
              )}
            ...
            <footer className="border-t border-rpc-border px-6 py-5">
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-rpc-button bg-rpc-button px-6 py-4 text-xs uppercase tracking-[0.2em] text-rpc-button-text transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
              >
...
function SuccessView({
  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center px-8 py-12 text-center">
      <div className="flex h-14 w-14 items-center justify-center rounded-full border border-rpc-text">
      ...
      <p className="mt-6 text-[10px] uppercase tracking-[0.25em] text-rpc-text/60">
        Cotización {quoteNumber}
      </p>

      <h2 className="mt-3 font-rpc-heading text-2xl font-light text-rpc-text">
      ...
      {dryRun && (
        <p className="mt-4 rounded border border-rpc-border bg-rpc-image-bg-light px-3 py-2 text-[10px] uppercase tracking-[0.18em] text-rpc-text/50">
      ...
      <div className="mt-8 flex w-full max-w-xs flex-col gap-3">
        ...
        <button
          type="button"
          onClick={onClose}
          className="text-xs uppercase tracking-[0.18em] text-rpc-text/60 underline-offset-4 hover:underline"
        >
          Cerrar
        </button>
      </div>
