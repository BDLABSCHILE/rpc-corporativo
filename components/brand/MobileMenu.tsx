...
export function MobileMenu() {
  ...
  const drawer = (
    ...
    >
      ...
      <div
        className={cn(
          "absolute right-0 top-0 isolate flex h-full w-[85%] max-w-sm flex-col bg-rpc-bg shadow-2xl transition-transform duration-300",
  ...
  return (
    <>
      <button
        ...
        className="flex h-10 w-10 items-center justify-center rounded-rpc-button text-rpc-text transition hover:bg-rpc-image-bg-light md:hidden"
      >
