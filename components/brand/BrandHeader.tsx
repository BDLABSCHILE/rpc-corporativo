      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6 lg:px-10">
        ...
        */}
        ...
        <nav className="hidden items-center gap-8 lg:flex">
          {NAV_LINKS.map((link) => (
            <Link
              ...
              className="whitespace-nowrap text-xs uppercase tracking-[0.18em] text-rpc-text/80 transition hover:text-rpc-text"
            >
              {link.label}
            </Link>
          ))}
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/catalogo"
            className="hidden whitespace-nowrap rounded-rpc-button bg-rpc-button px-5 py-2.5 text-xs uppercase tracking-[0.18em] text-rpc-button-text transition hover:opacity-90 md:inline-flex"
          >
            Ver catálogo
          </Link>
