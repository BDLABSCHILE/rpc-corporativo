...
export function Hero() {
  return (
    <>
      ...
      <section className="relative overflow-hidden border-b border-rpc-border bg-rpc-bg">
        <div className="mx-auto flex max-w-4xl flex-col items-center px-6 py-16 text-center sm:py-24 lg:px-10 lg:py-32">
          ...
          */}
          ...
          <p className="mt-4 text-[10px] uppercase tracking-[0.25em] text-rpc-text/60 sm:mt-6 sm:text-xs">
          ...
          */}
          ...
          <p className="mt-5 max-w-2xl font-rpc-body text-sm normal-case tracking-normal text-rpc-text/75 sm:mt-6 sm:text-base">
          ...
          <div className="mt-8 flex w-full flex-col gap-3 sm:mt-10 sm:w-auto sm:flex-row">
            <Link
              href="/catalogo"
              className="inline-flex items-center justify-center gap-2 rounded-rpc-button bg-rpc-button px-8 py-4 text-xs uppercase tracking-[0.2em] text-rpc-button-text transition hover:opacity-90"
            >
            ...
            <Link
              href="/contacto"
              className="inline-flex items-center justify-center rounded-rpc-button border border-rpc-text px-8 py-4 text-xs uppercase tracking-[0.2em] text-rpc-text transition hover:bg-rpc-text hover:text-rpc-button-text"
            >
              Hablar con un asesor
            </Link>
          </div>

          <p className="mt-6 font-rpc-body text-xs normal-case tracking-normal text-rpc-text/50 sm:mt-8">
      ...
      */}
      <section className="border-b border-rpc-border bg-rpc-bg">
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-10 lg:py-20">
          ...
          <h2 className="mt-3 max-w-3xl font-rpc-heading text-xl font-light leading-[1.15] text-rpc-text sm:text-2xl lg:text-3xl">
          ...
          <div className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-4 lg:gap-4 lg:mt-12">
            ...
            */}
            <Link
              href="/catalogo"
              className="group relative flex h-48 flex-col items-center justify-center gap-6 overflow-hidden bg-rpc-text p-6 text-rpc-button-text transition hover:opacity-90 sm:h-56 lg:h-72"
            >
              <Logo
                variant="inverted"
...
function CategoryCard({
  ...
  return (
    <Link
      href={href as never}
      className="group relative flex h-48 items-end overflow-hidden p-6 text-rpc-button-text sm:h-56 lg:h-72"
    >
